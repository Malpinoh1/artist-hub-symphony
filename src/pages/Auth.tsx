            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="p-8 bg-white border border-gray-200 rounded-xl shadow-lg">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 mb-6 bg-white border border-gray-300 text-gray-700 font-medium py-3 px-4 rounded-md hover:bg-gray-50 transition-colors disabled:opacity-50"
                >
